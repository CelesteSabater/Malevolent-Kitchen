...
namespace Project.RecipeTree.Editor
{
    public class RecipeTreeView : GraphView
    {
        ...
        Project.RecipeTree.Runtime.RecipeTree _tree;
        ...
        internal void PopulateView(Project.RecipeTree.Runtime.RecipeTree tree)
        {
            _tree = tree;
            ...
            if (_tree != null)
            {
                ...
                {
                    List<RecipeNode> children = Project.RecipeTree.Runtime.RecipeTree.GetChildren(parent);
