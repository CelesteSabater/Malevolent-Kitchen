...
public class Book : MonoBehaviour {
    ...
    {
        Sprite[] newList = CookingManager.Instance.GetCookbook();
        Sprite[] sum = new Sprite[bookPages.Length + newList.Length];
        bookPages.CopyTo(sum, 0);
        newList.CopyTo(sum, bookPages.Length);
        bookPages = sum;
    }
}
