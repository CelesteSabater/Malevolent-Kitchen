...
namespace Project.BehaviourTree.Editor
{
    public class BehaviourTreeEditor : EditorWindow
    {
        ...
        public void CreateGUI()
        {
            ...
            // Import UXML
            VisualTreeAsset visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Project/Behaviour Tree/Editor/UIBuilder/BehaviourTreeEditor.uxml");
            visualTree.CloneTree(root);

            // StyleSheet
            StyleSheet styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Project/Behaviour Tree/Editor/UIBuilder/BehaviourTreeEditor.uss");
